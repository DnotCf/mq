...
-- ----------------------------
INSERT INTO `SRIG_FORWARD_ROUTER` VALUES ('2', '5', '5', 'topic1', 'test1', null, null);
INSERT INTO `SRIG_FORWARD_ROUTER` VALUES ('3', '6', '5', 'dws_hw_gps_devc_tp_gpspoint_rt', 'test1', '2021-08-29 18:05:03', '');
...
CREATE TABLE `SRIG_MQ_SERVER` (
  ...
  `DEL_FLAG` tinyint(1) DEFAULT '1' COMMENT '0删除1未删除',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
-- ----------------------------
INSERT INTO `SRIG_MQ_SERVER` VALUES ('1', 'localhost', '1883', 'tcp', 'srig-mq-integration', 'MQTT', null, null, '5', null, '2021-07-21 14:59:10', null, null, null, null, null, null, null, null, null, null, '1');
INSERT INTO `SRIG_MQ_SERVER` VALUES ('2', '10.149.10.172', '1883', 'tcp', 'srig-mq-integration', 'MQTT', null, null, '5', null, '2021-07-21 14:59:10', null, null, null, null, null, null, null, null, null, null, '1');
INSERT INTO `SRIG_MQ_SERVER` VALUES ('3', 'localhost', '5672', 'tcp', 'foo', 'AMQP', null, null, '5', null, '2021-07-21 14:59:10', null, null, null, null, null, null, null, null, null, null, '1');
INSERT INTO `SRIG_MQ_SERVER` VALUES ('4', 'localhost', '1883', 'tcp', 'target', 'MQTT', null, null, '5', null, '2021-07-21 14:59:10', null, null, null, null, null, null, null, null, null, null, '1');
INSERT INTO `SRIG_MQ_SERVER` VALUES ('5', 'localhost', '9876', 'tcp', 'target', 'RocketMQ', '', '', '5', '', '2021-07-21 14:59:10', null, '127.0.0.1:9876', null, null, null, null, null, null, null, null, '1');
INSERT INTO `SRIG_MQ_SERVER` VALUES ('6', 'localhost', '9876', 'tcp', 'target', 'Aliyun_RocketMQ', '', '', '5', '', '2021-07-21 14:59:10', '2021-08-17 16:00:28', 'http://MQ_INST_1551934212811443_BXdv0RAB.mq-internet-access.mq-internet.aliyuncs.com:80', '', 'GID_TRACE_FUNSION_TT', '*', 'xHbzq7ntbOkS7HTPK2HqGBDX93UDkj', 'LTAI4GDmh8jPmnnozLrcNyLY', null, null, null, '1');
