...
import { directive as clickOutside } from 'view-design/src/directives/v-click-outside-x'
import TransferDom from 'view-design/src/directives/transfer-dom'
import { oneOf, findComponentsDownward } from 'view-design/src/utils/assist'
...
export default {
  ...
  computed: {
    ...
    canBeCleared () {
      ...
      // 这里之前判断了 !multiple，也就是多选的时候不显示清除按钮，我们现在支持了多选的时候也有清除按钮，
      // 支持一键清除 ycz 2020-03-02
